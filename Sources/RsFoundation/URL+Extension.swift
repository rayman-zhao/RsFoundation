import Foundation
    ...
    private func getVSFixedFileInfo(_ filename: String) -> String? {
    ...
    private func getFileVersionInfo(_ filename: String) -> [UInt8]? {
    ...
    private func getFileVersionInfoSize(_ filename: String) -> Int {
        return Int(GetFileVersionInfoSizeW(filename.wideString, nil))
    }

    extension URL {
        /// Standard application support directory as macOS.
